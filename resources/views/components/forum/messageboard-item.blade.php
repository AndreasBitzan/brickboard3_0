<div
    ...
    <div>
        <div class="relative p-2">
            <img @class(['h-full w-auto', 'grayscale opacity-70' => $read]) src="https://www.brickboard.de/assets/images/forum_icons/Icon_News.svg"
                alt="">
        </div>
    </div>

    <a href="{{ route('forum.detail', $messageboard) }}"
    @class(['text-gray-900 dark:text-white hover:text-brickred p-2 border-x flex flex-col justify-center',
     'border-gray-400' => $read, 'border-brickred' => !$read])>
    ...
    <div class="flex flex-col p-2">
        <div @class(['flex justify-between items-center pb-2 border-b', 'border-gray-400' => $read, 'border-brickred' => !$read]) >
